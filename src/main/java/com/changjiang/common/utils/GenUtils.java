...
import com.changjiang.common.domain.ColumnDO;
import com.changjiang.common.domain.TableDO;
...
//		}
		...
		if(template.contains("Mapper.xml.vm")){
			return "main" + File.separator + "resources" + File.separator + "mybatis/mapper" + File.separator + packageName + File.separator + className + "Mapper.xml";
		}
