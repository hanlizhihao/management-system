...
public class StoreController {
    ...
    @RequestMapping(value = "/storeId", produces = "text/plain;charset=UTF-8", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/enabledStoresByOraganization", produces = "application/json;charset=UTF-8", method = RequestMethod.POST)
    @ResponseBody
    public List<Store> getEnabledStoreByOraganization(@RequestParam("oraganization") Integer id) {
